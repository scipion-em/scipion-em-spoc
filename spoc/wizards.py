...
from spoc.viewers import ProtConfidenceMapViewer




class SpocColorScaleWizard(ColorScaleWizardBase):
        _targets = ColorScaleWizardBase.defineTargets(ProtConfidenceMapViewer)
